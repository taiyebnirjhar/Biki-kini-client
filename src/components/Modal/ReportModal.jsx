...
function ReportModal({ modalData }) {
  /**********************/
  const { setToggleReportModal, user, setLoading, loading } =
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/report`, {
      ...
      body: JSON.stringify(productReportData),
    })
      .then((res) => res.json())
      .then((data) => {
        if (data.acknowledged) {
          toast.success("repoted successfully 🦄!", {
            position: "top-center",
            autoClose: 5000,
